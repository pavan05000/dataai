               ...
               <div class="row justify-content-center">
                  <div class="col-xl-10">
                     <div class="breadcrumb__content text-center">
                        <h3 class="breadcrumb__title">Data Strategy & Planning
                        ...
                        <div class="breadcrumb__list breadcrumb__list-translate">
                           ...
                           <span>Services</span>
                           <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                           <span>Data Strategy & Planning</span>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                     ...
                     <div class="tp-service-widget">
                        <div class="tp-service-widget-item mb-40">
                           ...
                           <ul>
                                ...
                                <li><a class="active" href="data_strategy.php" class="dropdown-item">Data Strategy & Planning</a></li>
                  ...
                  <div class="col-lg-8">
                     <div class="tp-service-details-wrapper">
                        ...
                        <h3 class="tp-service-details-title">Empower Your Business with a Data-Driven Future</h3>
                        <p>In today's data-rich environment, a well-defined data strategy is crucial for unlocking the true potential of your information assets. Data & AI helps you navigate the complexities of data by crafting a comprehensive data strategy & planning roadmap.</p>
                        <!-- <div class="row">
                           <div class="col-lg-6">
                              ...
                              <div class="accordion" id="general_accordion">
                                 <div class="accordion-item tp-faq-active">
                                   ...
                                   <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We work closely with your stakeholders to understand your business objectives and translate them into a data-driven strategy that fuels growth.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>Our team designs a robust data architecture that facilitates efficient data collection, storage, management, and access – the foundation for successful data utilization.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We establish clear policies and procedures for data ownership, access control, and security to ensure responsible data management within your organization.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We define key performance indicators (KPIs) aligned with your data strategy, enabling you to track progress, measure success, and make data-driven adjustments.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
