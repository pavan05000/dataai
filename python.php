...
<!-- Mirrored from html.hixstudio.net/technix-prv/technix/portfolio.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2024 02:04:42 GMT -->
<head>
    <?php
      include('header.php')
      ?>
               ...
               <div class="row justify-content-center">
                  <div class="col-xl-10">
                     <div class="breadcrumb__content text-center">
                        <h3 class="breadcrumb__title">Python
         ...
         <section class="tp-portfolio-details-area pt-120 pb-120">
            <div class="container">
                  ...
                  <div class="col-lg-12">
                     <div class="tp-portfolio-details-wrapper">
                        <div class="tp-portfolio-details-thumb">
                           <img style="width:100%" src="assets/img/python.jpg" alt="">
                        </div>
               ...
               <div class="row">
                  <div class="col-lg-8">
                     <div class="">
                        <h3 class="tp-portfolio-details-title">Python</h3>
                        <p style="marign-bottom:1px !importent">
                       <strong> Introduction to Programming:</strong> 
                           <ul  style="list-style-type: none;">
                              <li style="padding-left:25px"> -> Variables</li>
                              <li style="padding-left:25px">-> Data types</li>
                              <li style="padding-left:25px">-> Operators</li>
                              <li style="padding-left:25px">-> if-else statements</li>
                              <li style="padding-left:25px">-> loops</li>
                           </ul>
                        </p>
                        <p style="marign-bottom:1px !importent">
                       <strong> Working with Data Structures:</strong> 
                           <ul  style="list-style-type: none;">
                              <li style="padding-left:25px"> -> Lists</li>
                              <li style="padding-left:25px">-> Tuples</li>
                              <li style="padding-left:25px">-> Dictionaries</li>
                              <li style="padding-left:25px">-> Sets – creation</li>
                              <li style="padding-left:25px">-> Manipulation</li>
                              <li style="padding-left:25px">-> Access methods</li>
                           </ul>
                        </p>
                        <p style="marign-bottom:1px !importent">
                       <strong> Functions & Modules:</strong> 
                           <ul  style="list-style-type: none;">
                              <li style="padding-left:25px"> ->  Defining and calling functions</li>
                              <li style="padding-left:25px">-> Code reusability</li>
                              <li style="padding-left:25px">-> Importing modules</li>
                              <li style="padding-left:25px">-> Libraries (NumPy, Pandas, Matplotlib)</li>
                              
                           </ul>
                        </p>
                        <p style="marign-bottom:1px !importent">
                       <strong>Object-Oriented Programming (OOP) Fundamentals:</strong> 
                           <ul  style="list-style-type: none;">
                              <li style="padding-left:25px"> ->  Classes</li>
                              <li style="padding-left:25px">-> Objects</li>
                              <li style="padding-left:25px">-> Methods</li>
                              <li style="padding-left:25px">-> Inheritance</li>
                              <li style="padding-left:25px">-> Encapsulation</li>
                              <li style="padding-left:25px">-> Abstraction</li>
                              <li style="padding-left:25px">-> Polymorphism</li>
                        ...
                        <p>
                       <strong> Data Handling & File I/O:</strong>  Reading and writing data from various file formats (CSV, text), data cleaning techniques.
                        </p>
                        <p style="marign-bottom:1px !importent">
                       <strong>Testing & Debugging:</strong> 
                           <ul  style="list-style-type: none;">
                              <li style="padding-left:25px"> ->  Introduction to unit testing</li>
                              <li style="padding-left:25px">-> Common errors</li>
                              <li style="padding-left:25px">-> Debugging strategies</li>
                           </ul>
                        </p>
                  ...
                  <div class="col-lg-4">
                     <div class="tp-portfolio-details-info-box">
                        <div class="tp-portfolio-details-info-address">
                           <h4 class="tp-portfolio-details-info-title"><span><svg width="26" height="30" viewBox="0 0 26 30" fill="none" xmlns="http://www.w3.org/2000/svg">
