               ...
               <div class="row justify-content-center">
                  <div class="col-xl-10">
                     <div class="breadcrumb__content text-center">
                        <h3 class="breadcrumb__title">Generative AI Fundamentals
         ...
         <section class="tp-portfolio-details-area pt-120 pb-120">
            <div class="container">
                  ...
                  <div class="col-lg-12">
                     <div class="tp-portfolio-details-wrapper">
                        <div class="tp-portfolio-details-thumb">
                           <img style="width:100%;height:450px" src="assets/img/genrative.png" alt="">
                        </div>
               ...
               <div class="row">
                  <div class="col-lg-8">
                     <div class="tp-portfolio-details-wrapper">
                        <h3 class="tp-portfolio-details-title">Generative AI Fundamentals</h3>
                        <p>
                       <strong>Introduction to Generative AI:</strong> Generative models and their applications (text generation, image generation).
                        </p>
                        <p>
                       <strong> Generative Adversarial Networks (GANs):</strong> Understanding the architecture and training process of GANs.
                        </p>
                        <p>
                       <strong>Variational Autoencoders (VAEs):</strong> Exploring VAEs as an alternative to GANs for learning latent representations of data.
                        </p>
                        <p>
                       <strong> Generative Pre-trained Transformers:</strong>  Introduction to models like GPT-3 and their capabilities in text generation.
                        </p>
                        <p>
                       <strong>   Applications of Generative AI:</strong>  Text-to-Image synthesis, creating realistic music samples, drug discovery.
                        <p>
                       <strong>  Ethical Considerations in Generative AI:</strong>   Potential biases in generative models, deepfakes, and responsible use of generative technologies.
                        </p>
