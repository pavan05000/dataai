               ...
               <div class="row justify-content-center">
                  <div class="col-xl-10">
                     <div class="breadcrumb__content text-center">
                        <h3 class="breadcrumb__title">Data Engineering &<br> Management
                        ...
                        <div class="breadcrumb__list breadcrumb__list-translate">
                           ...
                           <span>Services</span>
                           <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                           <span>Data Engineering & Management</span>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                        ...
                        <div class="tp-service-widget-item mb-40">
                           ...
                           <ul>
                                ...
                                <li><a href="data_strategy.php" class="dropdown-item">Data Strategy & Planning</a></li>
                                    <li><a  class="active" href="data_engineering.php" class="dropdown-item">Data Engineering &<br> Management</a></li>
                                    <li><a href="mi_ai.php" class="dropdown-item">Machine Learning </a></li>
                                    <li><a  href="deep_learning.php" class="dropdown-item">Deep Learning</a></li>
                  ...
                  <div class="col-lg-8">
                     <div class="tp-service-details-wrapper">
                        ...
                        <h3 class="tp-service-details-title">Build a Strong Foundation with Our Data Engineering Expertise</h3>
                        <p>In today's data-driven world, robust data infrastructure is essential for harnessing the power of your information. Data & AI provides comprehensive data engineering services to build a scalable and secure foundation for your data analytics initiatives.</p>
                        <!-- <div class="row">
                           <div class="col-lg-6">
                              ...
                              <div class="accordion" id="general_accordion">
                                 <div class="accordion-item tp-faq-active">
                                   ...
                                   <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We design and build automated data pipelines to seamlessly extract, transform, and load data from various sources into your data warehouse or data lake, ensuring efficient data flow.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We recommend and implement the right data storage solutions (data warehouses, data lakes, etc.) to optimize data accessibility, scalability, and cost-effectiveness for your needs.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We ensure the accuracy and consistency of your data through data cleansing, transformation, and validation processes, enabling reliable data-driven insights.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We leverage cloud-based data platforms and technologies to ensure your data infrastructure scales efficiently as your data volume grows, future-proofing your analytics capabilities.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#general_accordion">
                                      <div class="accordion-body">
                                        <p>We prioritize data security by implementing robust access controls, encryption, and monitoring practices to safeguard your valuable information assets.</p>
                                      </div>
                                    </div>
                                  </div>
                               </div>
