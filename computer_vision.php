               ...
               <div class="row justify-content-center">
                  <div class="col-xl-10">
                     <div class="breadcrumb__content text-center">
                        <h3 class="breadcrumb__title">Computer Vision
               ...
               <div class="row">
                        ...
                        <div class="tp-service-widget-item mb-40">
                           <div class="tp-service-widget-tab">
                              ...
                              <li><a href="data_strategy.php" class="dropdown-item">Data Strategy & Planning</a></li>
                                    ...
                                    <li><a class="active" href="computer_vision.php" class="dropdown-item">Computer Vision</a></li>
                              </ul>
                  ...
                  <div class="col-lg-8">
                     <div class="tp-service-details-wrapper">
                        ...
                        <h3 class="tp-service-details-title">Empower Your Machines with the Power of Sight - Computer Vision</h3>
                        <p>In today's data-rich world, images and videos hold a wealth of information. Data & AI's computer vision expertise empowers you to unlock this potential by enabling machines to intelligently "see" and analyze visual data.</p>
                        <!-- <div class="row">
                           <div class="col-lg-6">
                              ...
                              <div class="accordion" id="general_accordion">
                                 <div class="accordion-item tp-faq-active">
                                   ...
                                   <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We develop computer vision models to identify and localize objects within images and videos, enabling applications like product recognition or anomaly detection.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We create models to categorize images based on their content or segment specific regions within them, facilitating applications like content moderation or medical image analysis.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We develop systems to analyze video streams and recognize actions or events within them, enabling applications like traffic monitoring or behavior analysis.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We seamlessly integrate computer vision with robotics and automation systems, allowing robots to perceive their environment and interact with it more intelligently.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#general_accordion">
                                      <div class="accordion-body">
                                        <p>We go beyond pre-built models and develop custom computer vision solutions tailored to your specific needs and data, ensuring optimal performance for your unique use case.</p>
                                      </div>
                                    </div>
                                  </div>
                               </div>
