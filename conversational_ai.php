         ...
         <section class="tp-portfolio-details-area pt-120 pb-120">
            <div class="container">
                  ...
                  <div class="col-lg-12">
                     <div class="tp-portfolio-details-wrapper">
                        <div class="tp-portfolio-details-thumb">
                           <img style="width:100%;height:450px" src="assets/img/convnational.jpg" alt="">
                        </div>
               ...
               <div class="row">
                  <div class="col-lg-8">
                     <div class="tp-portfolio-details-wrapper">
                        <h3 class="tp-portfolio-details-title">Conversational AI</h3>
                        <p>
                       <strong> Chatbots & Virtual Assistants:</strong> Introduction to conversational AI, different types of chatbots (rule-based, statistical, retrieval-based).
                        </p>
                        <p>
                       <strong>Natural Language Processing (NLP) Techniques:</strong> Text preprocessing (tokenization, stemming, lemmatization), Text classification, Sentiment analysis.
                        </p>
                        <p>
                       <strong> Dialogue Management & State Tracking:</strong>  Techniques for managing conversation flow, keeping track of user context.
                        </p>
                        <p>
                       <strong> Optimization Techniques:</strong>  Building Chatbots with Python Libraries: Using libraries like Rasa, Dialogflow for chatbot development.
                        </p>
                        <p>
                       <strong>   Integrating Chatbots with Messaging Platforms:</strong>  Connecting chatbots to messaging platforms (Facebook Messenger, Telegram).
                        </p>
                        <p>
                       <strong>  Chatbot Evaluation & Improvement:</strong>   Metrics for evaluating chatbot performance, techniques for continuous improvement.
                        </p>
