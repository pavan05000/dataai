               ...
               <div class="row">
                        ...
                        <div class="tp-service-widget-item mb-40">
                           ...
                           <ul>
                                ...
                                <li><a href="data_strategy.php" class="dropdown-item">Data Strategy & Planning</a></li>
                                    ...
                                    <li><a class="active" href="mi_ai.php" class="dropdown-item">Machine Learning </a></li>
                  ...
                  <div class="col-lg-8">
                     <div class="tp-service-details-wrapper">
                        ...
                        <h3 class="tp-service-details-title">Unlock the Power of Data with Our Machine Learning & AI Expertise</h3>
                        <p>In today's data-driven world, machine learning and artificial intelligence are revolutionizing how businesses extract insights and automate tasks. Data & AI empowers you to leverage these cutting-edge technologies to transform your data into actionable intelligence.</p>
                        <!-- <div class="row">
                           <div class="col-lg-6">
                              ...
                              <div class="accordion" id="general_accordion">
                                 <div class="accordion-item tp-faq-active">
                                   ...
                                   <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We implement a wide range of machine learning algorithms (e.g., decision trees, random forests, deep learning) to tackle complex data challenges and deliver high-performance predictive models.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We transform raw data into high-quality features suitable for machine learning models, maximizing their effectiveness and ensuring accurate predictions.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We carefully select and optimize machine learning models based on your specific needs and data characteristics, ensuring the best possible performance and interpretability of results.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We deploy your trained machine learning models into production environments for real-time scoring and automation, enabling continuous value creation from your data assets.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#general_accordion">
                                      <div class="accordion-body">
                                        <p>We continuously monitor your deployed models to ensure performance and identify potential biases. We also provide clear explanations of how your models arrive at their predictions, fostering trust and transparency.</p>
                                      </div>
                                    </div>
                                  </div>
                               </div>
