               ...
               <div class="col-lg-4 col-md-6">
                  <div class="tp-footer-widget tp-footer-3-col-1">
                     <div class="tp-footer-logo">
                        <a href="index-2.php"> <img src="assets/img/logo/footer-logo.png" alt=""></a>
                     </div>
                     <div class="tp-footer-widget-content">
                        <div class="tp-footer-info">
                           <p class="p">The world’s first and largest digital marketplace <br> for crypto collectibles and non-fungible tokens (NFTs). Buy</p>
                           ...
                           <div class="tp-footer-main-mail">
                              <a href="mailto:needhelp@company.com"><i class="fa-light fa-message-dots"></i> Needhelp@company.com <br> +92 666 888 0000</a>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row">
               <div class="col-md-12 col-lg-8">
                  <div class="tp-footer-copyright-inner">
                     <p> ©Copyright <span>©2024</span> Data & AI. All Rights Reserved.</p>
                  </div>
               </div>
               <div class="col-md-12 col-lg-4">
                  <div class="tp-footer-copyright-inner text-lg-end">
                     <p>Designed By<a href="https://kondalu177.github.io/Myresume/" target='_blank'><span> Samuha. </span></a></p>
