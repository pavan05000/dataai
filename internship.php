               ...
               <div class="row justify-content-center">
                  <div class="col-xl-10">
                     <div class="breadcrumb__content text-center">
                        <h3 class="breadcrumb__title">Internships
               ...
               <div class="col-lg-6">
                  <div class="tp-service-breadcrumb-title-wrapper">
                     <!-- <span class="tp-section-title__pre">
                         Internship<span class="title-pre-color"> service</span>
                     ...
                     <h3 class="tp-section-title"><span class="title-color">Internship</span> Services
                     </h3>
                  </div>
               </div>
               <!-- <div class="col-lg-6">
            ...
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-service-3-content breadcrumb-item mb-30">
                     ...
                     <h4 class="tp-service-breadcrumb-title"><a href="#">Internship <br>  offer letter</a></h4>
                     <p>An offer letter is a written contract that confirms the terms of employment. </p>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-service-3-content breadcrumb-item mb-30">
                     ...
                     <h4 class="tp-service-breadcrumb-title"><a href="#">Real-time <br>  projects</a></h4>
                     <p>Real Time Projects by Expert Trainers with an In-depth implementation.</p>
                     <div class="tp-service-btn">
                        <!-- <a href="#">Read More <i class="fa-solid fa-arrow-up-right"></i></a> -->
                     </div>
                  </div>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-service-3-content breadcrumb-item mb-30">
                     ...
                     <h4 class="tp-service-breadcrumb-title"><a href="#">Proof of Concept <br>   building</a></h4>
                     <p>A proof of concept (POC) demonstrates the feasibility of a proposed product, method, or idea. </p>
                     <div class="tp-service-btn">
                        <!-- <a href="#">Read More <i class="fa-solid fa-arrow-up-right"></i></a> -->
                     </div>
                  </div>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-service-3-content breadcrumb-item mb-30">
                     ...
                     <h4 class="tp-service-breadcrumb-title"><a href="#">Internship <br> Certification</a></h4>
                     <p>Internship Certificate is a document that is used as proof or verification that a specific individual</p>
                     <div class="tp-service-btn">
                        <!-- <a href="#">Read More <i class="fa-solid fa-arrow-up-right"></i></a> -->
                     </div>
                  </div>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-service-3-content breadcrumb-item mb-30">
                     ...
                     <h4 class="tp-service-breadcrumb-title"><a href="#">Resume <br>  Enhancement</a></h4>
                     <p>The resume builder that's right for your job and experience · A feature-packed resume builder. </p>
                     <div class="tp-service-btn">
                        <!-- <a href="#">Read More <i class="fa-solid fa-arrow-up-right"></i></a> -->
                     </div>
                  </div>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-service-3-content breadcrumb-item mb-30">
                     ...
                     <h4 class="tp-service-breadcrumb-title"><a href="#">Career Guidance</a></h4>
                     <p>Career guidance is a process that assists individuals in identifying their career goals and pursuing the right path to achieve them.</p>
                     <div class="tp-service-btn">
                        <!-- <a href="#">Read More <i class="fa-solid fa-arrow-up-right"></i></a> -->
                     </div>
                  </div>
               ...
               <!-- <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="tp-service-3-content breadcrumb-item mb-30">
                     ...
                     <h4 class="tp-service-breadcrumb-title"><a href="service-details.html">Clouds Backup <br> Services</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="tp-service-3-content breadcrumb-item mb-30">
                     ...
                     <h4 class="tp-service-breadcrumb-title"><a href="service-details.html">Machine Learning <br> And Ai</a></h4>
                     <p>Transmax is the world tr
                        we uphold industry Cu
                        stomer Oriented </p>
                     <div class="tp-service-btn">
               ...
               <div class="col-xl-8 text-center">
                  <div class="tp-about-call fadeUp">
                     <a href="tel:01310-069824">
                        <p><i class="fa-solid fa-phone"></i> Provide IT services to hundreds customers <span>+88 01310-069824</span></p>
                     </a>
                  </div>
               </div>
            </div> -->
