         ...
         <section class="tp-portfolio-details-area pt-120 pb-120">
            <div class="container">
                  ...
                  <div class="col-lg-12">
                     <div class="tp-portfolio-details-wrapper">
                        <div class="tp-portfolio-details-thumb">
                           <img style="width:100%;height:450px" src="assets/img/deep.jpg" alt="">
                        </div>
                        <div class="tp-portfolio-details-meta d-flex flex-wrap justify-content-between">
                           ...
                           <div class="tp-portfolio-details-meta-item d-flex align-items-center">
                                 ...
                                 <div class="tp-portfolio-details-meta-content">
                                    ...
                                    <p>4-6 Weeks (This assumes prior ML knowledge)</p>
                                 </div>
                           </div>
                           <!-- <div class="tp-portfolio-details-meta-item d-flex align-items-center">
                                 <div class="tp-portfolio-details-meta-icon">
               ...
               <div class="row">
                  <div class="col-lg-8">
                     <div class="tp-portfolio-details-wrapper">
                        <h3 class="tp-portfolio-details-title">Deep Learning</h3>
                        <p>
                       <strong> Artificial Neural Networks (ANNs):</strong> Structure of neural networks (perceptrons, layers, activation functions).
                        </p>
                        <p>
                       <strong> Deep Learning Architectures:</strong> Convolutional Neural Networks (CNNs) for image recognition, Recurrent Neural Networks (RNNs) for sequence data (e.g., text).
                        </p>
                        <p>
                       <strong>  Deep Learning Libraries:</strong> TensorFlow, PyTorch – Introduction to building and training deep learning models.
                        </p>
                        <p>
                       <strong> Optimization Techniques:</strong>  Gradient descent, backpropagation for training deep learning models.
                        </p>
                        <p>
                       <strong>   Regularization Techniques:</strong> Preventing overfitting in deep learning models (dropout, L1/L2 regularization).
                        </p>
                        <p>
                       <strong>  Deep Learning Applications:</strong>  Image classification, natural language processing, time series forecasting.
                        </p>
