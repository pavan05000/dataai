               ...
               <div class="row justify-content-center">
                  <div class="col-xl-10">
                     <div class="breadcrumb__content text-center">
                        <h3 class="breadcrumb__title">Conversational AI
               ...
               <div class="row">
                        ...
                        <div class="tp-service-widget-item mb-40">
                           ...
                           <ul>
                                ...
                                <li><a href="data_strategy.php" class="dropdown-item">Data Strategy & Planning</a></li>
                                    ...
                                    <li><a class="active" href="conversational.php" class="dropdown-item">Conversational AI</a></li>
                  ...
                  <div class="col-lg-8">
                     <div class="tp-service-details-wrapper">
                        ...
                        <h3 class="tp-service-details-title">Revolutionize Customer Interactions with Conversational AI</h3>
                        <p>In today's digital age, customers expect personalized and efficient interactions. Data & AI helps you implement cutting-edge conversational AI solutions to enhance customer engagement and streamline communication channels.</p>
                        <!-- <div class="row">
                           <div class="col-lg-6">
                              ...
                              <div class="accordion" id="general_accordion">
                                 <div class="accordion-item tp-faq-active">
                                   ...
                                   <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We design conversational AI solutions that seamlessly integrate with your existing channels (websites, messaging apps, etc.) to provide a consistent and convenient customer experience.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We leverage advanced NLU techniques to enable your AI assistant to understand natural language queries and respond in a way that feels human-like and engaging.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>Our solutions personalize interactions by integrating with your CRM systems, allowing the AI to tailor responses based on user data and past interactions.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                   ...
                                   <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#general_accordion">
                                     <div class="accordion-body">
                                       <p>We empower your AI assistant to handle routine inquiries and tasks, freeing up human agents for complex issues and fostering customer self-sufficiency.</p>
                                     </div>
                                   </div>
                                 </div>
                                 <div class="accordion-item">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#general_accordion">
                                      <div class="accordion-body">
                                        <p>We implement mechanisms for your conversational AI to learn and adapt over time, ensuring it stays relevant and delivers an exceptional user experience.</p>
                                      </div>
                                    </div>
                                  </div>
                               </div>
