         ...
         <section class="tp-portfolio-details-area pt-120 pb-120">
            <div class="container">
                  ...
                  <div class="col-lg-12">
                     <div class="tp-portfolio-details-wrapper">
                        <div class="tp-portfolio-details-thumb">
                           <img style="width:100%" src="assets/img/ml.webp" alt="">
                        </div>
               ...
               <div class="row">
                  <div class="col-lg-8">
                     <div class="tp-portfolio-details-wrapper">
                        <h3 class="tp-portfolio-details-title">Machine Learning</h3>
                        <p>
                       <strong> Supervised Learning:</strong>  Introduction to classification (Logistic Regression, Decision Trees) and regression (Linear Regression) algorithms.
                        </p>
                        <p>
                       <strong>Unsupervised Learning:</strong> Techniques like K-Means clustering, Principal Component Analysis (PCA) for dimensionality reduction.
                        </p>
                        <p>
                       <strong>Model Evaluation Metrics:</strong> Accuracy, precision, recall, F1-score, confusion matrix interpretation.
                        </p>
                        <p>
                       <strong>Model Selection & Cross-Validation:</strong> Techniques for choosing the best performing model and preventing overfitting.
                        </p>
                        <p>
                       <strong>Feature Engineering: </strong>    Data preprocessing, feature scaling, handling missing values, creating new features.
                        </p>
                        <p>
                       <strong> Machine Learning Pipelines:</strong>   Building reusable workflows for data preparation, model training, and evaluation.
